            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        int shakeAmnt = Random.Range(-3, 3);
                        
                        copyOfVertices[materialIndex][vertexIndex + 0] = sourceVertices[vertexIndex + 0] + new Vector3(shakeAmnt, shakeAmnt, shakeAmnt);
                        copyOfVertices[materialIndex][vertexIndex + 1] = sourceVertices[vertexIndex + 1] + new Vector3(shakeAmnt, shakeAmnt, shakeAmnt);
                        copyOfVertices[materialIndex][vertexIndex + 2] = sourceVertices[vertexIndex + 2] + new Vector3(shakeAmnt, shakeAmnt, shakeAmnt);
                        copyOfVertices[materialIndex][vertexIndex + 3] = sourceVertices[vertexIndex + 3] + new Vector3(shakeAmnt, shakeAmnt, shakeAmnt);
